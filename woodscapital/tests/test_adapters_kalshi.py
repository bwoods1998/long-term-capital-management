...
from woodscapital.broker import Instrument, OrderIntent, RejectedOrder, UnknownOutcome, VenueUnavailable
from woodscapital.data import TransportError
from woodscapital.data.kalshi import BASE
from woodscapital.adapters import KalshiCredentials
from woodscapital.adapters.kalshi import (
    CAPABILITIES,
    ORDERS_PATH,
    ORDERS_PATH_V2,
    PREFIX,
...
class V2DefaultTests(unittest.TestCase):
    ...
    def make_v2(self, routes=None, **kwargs):
        ...
        from woodscapital.broker import Quote
