...
from woodscapital.service import DeskContext, Service, load_env
from woodscapital.tests.test_gateway import FakeBroker
...
class MarkTests(ServiceCase):
    ...
    def test_a_mark_carries_the_shape_the_site_needs(self):
        ...
        from woodscapital.broker import OrderIntent
...
class ContextTests(ServiceCase):
    ...
    def test_quote_positions_and_balance_return_domain_objects(self):
        from woodscapital.broker import Balance, Position
