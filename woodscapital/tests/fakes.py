"""Injected doubles for the Woods Capital tests.

Nothing under `woodscapital/tests/` opens a socket, reads a credential or looks at a wall clock.
...
from woodscapital.broker import Instrument, Quote, money
from woodscapital.data import DataError, TransportError, iso, us_equity_session
...
class Clock:
    ...
    def __init__(self, start: Any = "2026-09-15T13:30:00Z"):
        from woodscapital.data import to_datetime
