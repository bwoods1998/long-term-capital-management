...
`woodscapital/tests/test_data_calendar.py`.
...
same `get`/`request` signature; nothing under `woodscapital/tests/` opens a socket.
"""
...
USER_AGENT = "WoodsCapital/0.1 (blakewoods.us; blakewoods98@gmail.com)"
...
class HttpTransport:
    ...
    Every network read in `woodscapital.data` goes through one of these. Responses are capped at
