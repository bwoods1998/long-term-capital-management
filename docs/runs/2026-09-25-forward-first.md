...
Snapshot 22:36-22:42Z (ledger to 22:36:08Z; release `20260925T205243Z-8f1ce807b14d`, K1 on top of Deploy A).

| # | Metric | Reading (each number names its function) | Target at the end |
|---|---|---|---|
| 1 | Real settled profit a day (24 h) against compute a day (24 h); proven families and each one's capacity at its real size | `real_settled` -$16.81 a day realized (44 settlements $1.02, 10 closing sales -$17.84); `compute_per_day` $119.31 a day (OpenAI $93.20: Luna $34.46, Astra $54.61, lab $4.13; Sail $26.07; Jev $0.03); lifetime $659.59 ($650.95 by scripts/economics.py + $8.65 lab); `gateway_meter` the gateway metered the OpenAI line at $97.41 a day over 22.2 h; `unit_economics` compute - the profit: short of the target; `proven_capacity` 2 proven: megacaps-chip-demand-relay $0.07/day at $12.50 (the board), `capacity_at_sizes` $0.18 / $0.36 / - a day at 1x/2x/4x of $25.00 (the median bid; no real bid yet); sports-central-run-under $24.54/day at $6.00 (the board), `capacity_at_sizes` $27.06 / $54.12 / - a day at 1x/2x/4x of $5.39 (the median real bid) | compute <= 2 x real settled profit, or <= $60/day while no family swings; >= 3 proven families, capacity measured at 1x, 2x and 4x the stake |
| 2 | Forward-positive share of the last day's graduates and newborns (lab forward windows, first practice day); living median W_paper; agents above the 1.01 line | `forward_positive` graduates 13 of 18 with an active forward block (72%; 91 graduated, 78 with a window); newborns 10 of 29 on their first practice day so far (34%; 110 born), first day ended 29 of 65 (45%); lab-born active blocks 110 of 244 (45%, the baseline's measure); `practice_standing` median W_paper 1.00031 over 125; 34 above the 1.01 line (E at bunt_at 1.01: 25) | >= 60%; >= 1.005; >= 50 |
| 3 | Real dollars on proven families / on unproven (stake); the first family swing; Alpaca real stock agents (ever) | `real_dollars` $16.62 proven / $208.21 unproven; `capital_on_proof` no family swing yet: megacaps-chip-demand-relay 0 real settlements, 15 to go (look at 15, - days); sports-central-run-under 12 real settlements, 3 to go (look at 15, 0.69 days); Alpaca real stock agents ever: 0 filled (0 in a session), 0 staked on a stock desk | proven >= unproven; the swing reached at the sports family's 10th settlement, or the exact count why not; >= 2 during a session |
| 4 | House restarts a day; releases rolled back by causes outside the House (vendor, backup, site); tick p50; deploys inside a US session | `restarts` 19 in the window (19.0 a day), 4 inside a US session; `deploy_record` 5 releases rolled back, 5 by causes outside the House (backup 5); 3 of 16 deploys inside a US session (from deploys.jsonl); `tick_p50` interval p50 66.2 s over 1182 ticks (p90 108.4 s); the last tick 15.4 s | <= 6; 0; <= 40 s; 0 |
| 5 | Waiters over 2 h and the longest; merged strategies never born; median life against each desk's evidence clock; displacement share of deaths | `seat_queue` 99 of 112 waiters over 2 h (29 on desks with a free seat), the longest 78.8 h (cards on kalshi-weather); 24 merged strategies waiting (the seat market at 2026-09-25T22:06:38.766Z); `life_vs_clock` median life under the desk's clock on 3 of 8 desks (alpaca-megacaps 4.6 h < 22.3 h, kalshi-open 1.1 h < 2.0 h, kalshi-sports 12.1 h < 21.6 h); `displacement_share` 76% of 110 deaths in the window (88% of 609 lifetime) | 0 with free capacity, longest < 2 h; 0; >= the clock on every desk; < 50% |
| 6 | Real fill rate (fills / orders, 24 h); real entries refused a day; taker entries by probes | `real_fill_rate` 80 of 265 orders filled (30%; kalshi 61 of 95, alpaca 19 of 170); the baseline's rows measure 85 of 1132 (8%); `real_refusals` 430 real entries refused (430 a day), 151 in the last session (2026-09-25); the most: allocator.max_event_share 184, insufficient desk cash 157, allocator.real_entry_liquidity 46; `probe_taker_entries` 0 Kalshi taker entries by probes ($0.00), 46 probe entries refused for taking; Alpaca books every fill a taker (10 probe entries, $111.19) | >= 25%; < 30; allowed and measured |
| 7 | Sail runway; the October OpenAI cap; the population ceiling binding on runway | `runway` Sail 4.81 days ($131.05 less $5.00 reserve at $26.19 a day; the House reads 4.82); the OpenAI month 2026-09 at $596.85 of $607.00, October's cap unset; the population ceiling does not bind on runway (128 of 128; 0 population alerts in the window) | >= 5 days throughout; set from funded money at the owner's word; never |

State: Deploy A is live and verified; main holds Deploy B (merged 22:18:39Z to hold the updater off Merton's #346 during
the real games) for the 06:00Z owner deploy; Deploy C (#335) is assembled with H3b. **Sail runway 4.81 days, under the
5-day line** (burn $26.19 a day, up from $16 at T0: the OpenAI month is at $596.85 of $607 and research has moved to
Sail); Deploy B's F2 (about -58% of research sessions on the T0 day's replay) and C's lane throttle are the levers, and
a Sail top-up is the owner's step. Real settled a day -$16.81: 44 settlements +$1.02 (the sports family's Sept 24 slate
2 of 6) and 10 closing sales -$17.84 (krasker-14's drained options, -$18.00). Graduates with a positive forward block 13
of 18 (F1 is not live yet); waiters 112 (99 over 2 h), 24 merged strategies waiting (F3 not live yet).

### T+14.2 h (18:37Z Sept 25, inside the US session; nothing of this run deployed yet)

Snapshot 18:37-18:40Z (ledger to 18:37:28Z; release `20260925T183013Z-19fb86ee4720`, the options run's latest).

| # | Metric | Reading (each number names its function) | Target at the end |
|---|---|---|---|
| 1 | Real settled profit a day (24 h) against compute a day (24 h); proven families and each one's capacity at its real size | `real_settled` $1.53 a day realized (50 settlements $19.02, 9 closing sales -$17.50); `compute_per_day` $126.99 a day (OpenAI $105.84: Luna $40.93, Astra $59.69, lab $5.22; Sail $21.11; Jev $0.03); lifetime $647.62 ($638.98 by scripts/economics.py + $8.65 lab); `gateway_meter` the gateway metered the OpenAI line at $108.21 a day over 22.2 h; `unit_economics` compute 83.2x the profit: short of the target; `proven_capacity` 3 proven: megacaps-chip-demand-relay $0.08/day at $12.50 (the board), `capacity_at_sizes` $0.20 / $0.41 / - a day at 1x/2x/4x of $25.00 (the median bid; no real bid yet); megacaps-quiet-vwap-reclaim $0.08/day at $12.50 (the board), `capacity_at_sizes` $0.36 / $0.73 / $1.45 a day at 1x/2x/4x of $50.00 (the median bid; no real bid yet); sports-central-run-under $26.00/day at $6.00 (the board), `capacity_at_sizes` $28.61 / $57.22 / - a day at 1x/2x/4x of $5.39 (the median real bid) | compute <= 2 x real settled profit, or <= $60/day while no family swings; >= 3 proven families, capacity measured at 1x, 2x and 4x the stake |
| 2 | Forward-positive share of the last day's graduates and newborns (lab forward windows, first practice day); living median W_paper; agents above the 1.01 line | `forward_positive` graduates 7 of 12 with an active forward block (58%; 97 graduated, 76 with a window); newborns 9 of 41 on their first practice day so far (22%; 123 born), first day ended 33 of 61 (54%); lab-born active blocks 110 of 249 (44%, the baseline's measure); `practice_standing` median W_paper 1.00015 over 125; 34 above the 1.01 line (E at bunt_at 1.01: 24) | >= 60%; >= 1.005; >= 50 |
| 3 | Real dollars on proven families / on unproven (stake); the first family swing; Alpaca real stock agents (ever) | `real_dollars` $16.62 proven / $218.22 unproven; `capital_on_proof` no family swing yet: megacaps-chip-demand-relay 0 real settlements, 15 to go (look at 15, - days); megacaps-quiet-vwap-reclaim 0 real settlements, 15 to go (look at 15, - days); sports-central-run-under 12 real settlements, 3 to go (look at 15, 0.64 days); Alpaca real stock agents ever: 0 filled (0 in a session), 0 staked on a stock desk | proven >= unproven; the swing reached at the sports family's 10th settlement, or the exact count why not; >= 2 during a session |
| 4 | House restarts a day; releases rolled back by causes outside the House (vendor, backup, site); tick p50; deploys inside a US session | `restarts` 23 in the window (23.0 a day), 6 inside a US session; `deploy_record` 6 releases rolled back, 6 by causes outside the House (backup 6); 5 of 19 deploys inside a US session (from deploys.jsonl); `tick_p50` interval p50 71.3 s over 1059 ticks (p90 109.8 s); the last tick 58.6 s | <= 6; 0; <= 40 s; 0 |
| 5 | Waiters over 2 h and the longest; merged strategies never born; median life against each desk's evidence clock; displacement share of deaths | `seat_queue` 83 of 133 waiters over 2 h (14 on desks with a free seat), the longest 74.8 h (cards on kalshi-weather); 31 merged strategies waiting (the seat market at 2026-09-25T17:50:35.135Z); `life_vs_clock` median life under the desk's clock on 3 of 8 desks (alpaca-megacaps 4.6 h < 22.3 h, kalshi-open 1.1 h < 2.0 h, kalshi-sports 13.4 h < 21.6 h); `displacement_share` 74% of 105 deaths in the window (88% of 595 lifetime) | 0 with free capacity, longest < 2 h; 0; >= the clock on every desk; < 50% |
| 6 | Real fill rate (fills / orders, 24 h); real entries refused a day; taker entries by probes | `real_fill_rate` 79 of 244 orders filled (32%; kalshi 60 of 94, alpaca 19 of 150); the baseline's rows measure 84 of 1037 (8%); `real_refusals` 385 real entries refused (385 a day), 119 in the last session (2026-09-25); the most: allocator.max_event_share 178, insufficient desk cash 121, allocator.real_entry_liquidity 45; `probe_taker_entries` 0 Kalshi taker entries by probes ($0.00), 45 probe entries refused for taking; Alpaca books every fill a taker (11 probe entries, $126.19) | >= 25%; < 30; allowed and measured |
| 7 | Sail runway; the October OpenAI cap; the population ceiling binding on runway | `runway` Sail 6.37 days ($139.18 less $5.00 reserve at $21.05 a day; the House reads 6.43); the OpenAI month 2026-09 at $591.21 of $607.00, October's cap unset; the population ceiling does not bind on runway (128 of 128; 0 population alerts in the window) | >= 5 days throughout; set from funded money at the owner's word; never |

State: Deploy A (#323) set for 20:10Z; Deploy B (#334) and C (#335) assembled and reviewed. Real settled a day fell to
$1.53: nine closing sales -$17.50, of which -$18.00 is krasker-14's options probe (the R5 drain of Sept 24 completing:
AAL contracts sold at $0.04 at 13:31Z and $0.12 at 15:04Z, bought for $34 on Sept 24); the crypto-alts probes'
take-profits made +$0.87. A third family reads proven (`megacaps-quiet-vwap-reclaim`, practice only, $0.36/day at
$50). Sail burn rose to $21.05 a day (runway 6.37 days) as OpenAI nears its tiers ($591.21 of $607): Deploy B's F2
(research sessions about -58% on the T0 day) and C's lane throttle are the levers; at this burn the 5-day line is
reached on Saturday evening unless they land or the owner tops up Sail.

### T+10.2 h (14:36Z Sept 25, inside the US session; nothing of this run deployed yet)

Snapshot 14:36-14:39Z (ledger to 14:36:40Z; release `20260925T114915Z-007e06151f53`, the Jev run's D-J1, which carries
H3 and Z from the options run's Deploy V).

| # | Metric | Reading (each number names its function) | Target at the end |
|---|---|---|---|
| 1 | Real settled profit a day (24 h) against compute a day (24 h); proven families and each one's capacity at its real size | `real_settled` $7.78 a day realized (54 settlements $18.11, 6 closing sales -$10.33); `compute_per_day` $125.74 a day (OpenAI $108.37: Luna $42.14, Astra $60.70, lab $5.53; Sail $17.33; Jev $0.04); lifetime $627.47 ($619.33 by scripts/economics.py + $8.15 lab); `gateway_meter` the gateway metered the OpenAI line at $110.80 a day over 22.4 h; `unit_economics` compute 16.2x the profit: short of the target; `proven_capacity` 2 proven: megacaps-chip-demand-relay $0.07/day at $12.50 (the board), `capacity_at_sizes` $0.17 / $0.34 / - a day at 1x/2x/4x of $25.00 (the median bid; no real bid yet); sports-central-run-under $27.57/day at $6.00 (the board), `capacity_at_sizes` $30.36 / $60.72 / - a day at 1x/2x/4x of $5.39 (the median real bid) | compute <= 2 x real settled profit, or <= $60/day while no family swings; >= 3 proven families, capacity measured at 1x, 2x and 4x the stake |
| 2 | Forward-positive share of the last day's graduates and newborns (lab forward windows, first practice day); living median W_paper; agents above the 1.01 line | `forward_positive` graduates 6 of 10 with an active forward block (60%; 89 graduated, 76 with a window); newborns 5 of 29 on their first practice day so far (17%; 101 born), first day ended 43 of 73 (59%); lab-born active blocks 111 of 236 (47%, the baseline's measure); `practice_standing` median W_paper 1.00015 over 125; 35 above the 1.01 line (E at bunt_at 1.01: 24) | >= 60%; >= 1.005; >= 50 |
| 3 | Real dollars on proven families / on unproven (stake); the first family swing; Alpaca real stock agents (ever) | `real_dollars` $16.62 proven / $298.21 unproven; `capital_on_proof` no family swing yet: megacaps-chip-demand-relay 0 real settlements, 15 to go (look at 15, - days); sports-central-run-under 12 real settlements, 3 to go (look at 15, 0.6 days); Alpaca real stock agents ever: 0 filled (0 in a session), 0 staked on a stock desk | proven >= unproven; the swing reached at the sports family's 10th settlement, or the exact count why not; >= 2 during a session |
| 4 | House restarts a day; releases rolled back by causes outside the House (vendor, backup, site); tick p50; deploys inside a US session | `restarts` 24 in the window (24.0 a day), 7 inside a US session; `deploy_record` 7 releases rolled back, 6 by causes outside the House (backup 6, house 1); 5 of 19 deploys inside a US session (from deploys.jsonl); `tick_p50` interval p50 72.7 s over 1009 ticks (p90 118.7 s); the last tick - s | <= 6; 0; <= 40 s; 0 |
| 5 | Waiters over 2 h and the longest; merged strategies never born; median life against each desk's evidence clock; displacement share of deaths | `seat_queue` 73 of 86 waiters over 2 h (2 on desks with a free seat), the longest 28.8 h (graduates on kalshi-crypto-strikes); 30 merged strategies waiting (the seat market at 2026-09-25T13:47:59.495Z); `life_vs_clock` median life under the desk's clock on 3 of 8 desks (alpaca-megacaps 4.6 h < 22.3 h, kalshi-open 1.1 h < 2.0 h, kalshi-sports 14.7 h < 21.6 h); `displacement_share` 80% of 85 deaths in the window (90% of 565 lifetime) | 0 with free capacity, longest < 2 h; 0; >= the clock on every desk; < 50% |
| 6 | Real fill rate (fills / orders, 24 h); real entries refused a day; taker entries by probes | `real_fill_rate` 83 of 242 orders filled (34%; kalshi 65 of 98, alpaca 18 of 144); the baseline's rows measure 88 of 1027 (9%); `real_refusals` 380 real entries refused (380 a day), 27 in the last session (2026-09-25); the most: allocator.max_event_share 189, insufficient desk cash 88, allocator.real_entry_liquidity 54; `probe_taker_entries` 0 Kalshi taker entries by probes ($0.00), 56 probe entries refused for taking; Alpaca books every fill a taker (15 probe entries, $182.01) | >= 25%; < 30; allowed and measured |
| 7 | Sail runway; the October OpenAI cap; the population ceiling binding on runway | `runway` Sail 8.07 days ($145.24 less $5.00 reserve at $17.37 a day; the House reads 8.07); the OpenAI month 2026-09 at $577.08 of $607.00, October's cap unset; the population ceiling does not bind on runway (128 of 128; 0 population alerts in the window) | >= 5 days throughout; set from funded money at the owner's word; never |

State: Deploy A (#323) is green and set for 20:10Z; Deploy B (#334: Wave 1 with its reviews, money digest `acff5c64`) is
assembled and in CI; Wave 2 (X #332, S #331, Y #330, the publisher #325) is being integrated on `c/integration` (Y
rebasing onto the F-research review). The site's flywheel strip is live (12:35Z). Real settled a day fell to $7.78 (six
closing sales -$10.33 against 54 settlements +$18.11); unproven real stake $298.21. The OpenAI month reads $577.08 of
$607: the "earned" tier (under $20) is near. Waiters 86 (30 merged strategies), the longest 28.8 h: F3 is not live yet.
