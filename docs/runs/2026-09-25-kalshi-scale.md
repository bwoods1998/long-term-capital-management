...
- **Announced deploys:** **Deploy K1** (House; no money-digest change) Friday Sept 25 from about 21:05Z: after the
  ...
  ATL-MIA 23:10Z, TEX-MIN 00:10Z, AZ-SD 01:40Z, LAD-SF 02:15Z; else it moves to Saturday after B, G and D-J1. Its
...
| K1a-review | Three-lens review of the sports seed, the recorders and the listing keys | running (`k1/consensus-review`, 10:38Z) |
...
| K1c | Tennis, MMA, golf, cricket on the ESPN league map (`SPORTS_SERIES`/`SPORTS_LEAGUES`, odds where the core API has lines) + match-winner consensus founders, tennis first | building (`k1c/more-sports` on `k1/sports-consensus`, 10:40Z): a go/no-go probe first (a founder only where ESPN carries a line); Deploy K1 if reviewed in time, else K2 |
