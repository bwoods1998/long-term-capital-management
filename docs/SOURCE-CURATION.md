...
The [synthetic fixture](../tests/test_source_curation.py) demonstrates the complete
...
The [validation record](../data/experiments/source-curation-validation-2026-09-13.json)
