...
source notes (`experiments/data/research/source-notes.json`) and try
...
follow-up protocol (`experiments/data/experiments/synthesis-policy-2026-09-13.json`) freezes one
...
A distinct v2 follow-up (`experiments/data/experiments/synthesis-policy-v2-2026-09-13.json`)
