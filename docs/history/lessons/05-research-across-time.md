...
The [recorded replay](../../../experiments/public/trajectory-replay.json) follows three fictional
...
in [Sail products](../../SAIL-PRODUCTS.md#cache-economics-before-enabling-another-product)
...
Useful wakeups matter too. The [source watcher](../pre-portfolio-2026-09-13/SOURCE-WATCH.md) found that
...
[reviewed bundle handoff](../pre-portfolio-2026-09-13/SOURCE-CURATION.md) now has an offline synthetic
