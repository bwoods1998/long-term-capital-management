...
The [public dataset](../public/cash-map.json) preserves current and prior figures, deductions, source URLs and capture hashes. The [review record](../data/research/cash-map-review.json) binds the published bytes to a source-table and arithmetic review by an AI coding agent. It does not approve investment theses. [Reproduce all 18 bridges](START-HERE.md).
