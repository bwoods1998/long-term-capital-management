...
FORBIDDEN: tuple[str, ...] = (
    ...
    # The scale rule's arithmetic (K5, review of #313): which tranches the owner's version-2 grant unlocks and when they
    # are withdrawn. Its constants ride the ratified policy, its functions do not: only the owner's deploy changes them.
    "league/grants.py",
