# A frozen copy of league/book.py as it stands on origin/main at 5ff775e (Sept 25, 2026), before the options-desk
# run's structure-only hunks. league/tests/test_structure_book_invariance.py loads it as `league._book_before` and
# runs the same no-structure scenarios on it and on league/book.py. Never edited; never imported by the House.
