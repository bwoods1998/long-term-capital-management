...
class Local(unittest.TestCase):
    ...
    def test_decide_round_trip(self):
        ...
        self.assertEqual(sorted(p.name for p in directory.iterdir() if p.is_file()), ["options_history.py", "options_replay.py", "replay.py", "runner.py", "safety.py", "spec.json", "structure_core.py"])
...
class KitFiles(ToolsCase):
    def test_the_kit_is_the_three_programs_then_every_tool_module_by_name(self):
        ...
        files = kit_files()
        self.assertEqual(list(files), ["runner.py", "replay.py", "safety.py", "options_replay.py", "options_history.py", "structure_core.py", "tools/__init__.py", "tools/alpha.py", "tools/edge.py"])
...
class LocalTools(ToolsCase):
    ...
    def test_the_agents_directory_holds_the_tools_as_a_package_and_nothing_else_from_there(self):
        ...
        self.assertEqual(sorted(str(p.relative_to(directory)) for p in directory.rglob("*") if p.is_file()),
                         ["options_history.py", "options_replay.py", "replay.py", "runner.py", "safety.py", "structure_core.py", "tools/__init__.py", "tools/edge.py"])
...
class SailTools(ToolsCase):
    ...
    def test_the_tools_are_uploaded_with_the_kit_as_a_package(self):
        ...
        kit = kit_dir()
        self.assertEqual(self.uploads(), [f"{kit}/runner.py", f"{kit}/replay.py", f"{kit}/safety.py", f"{kit}/options_replay.py", f"{kit}/options_history.py", f"{kit}/structure_core.py", f"{kit}/tools/__init__.py",
    ...
    def test_a_withdrawn_tool_is_not_in_the_directory_the_program_runs_from(self):
        ...
        self.assertEqual(ran["in_cwd"], ["options_history.py", "options_replay.py", "replay.py", "runner.py", "safety.py", "spec.json", "structure_core.py", "tools/__init__.py", "tools/other.py"])
