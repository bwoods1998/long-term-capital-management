"""The structure founders the House seats (the options-desk run, Sept 25, 2026; written by builder S4b).
...
#: The structure founders delivered to the House: the ones that passed the House's structure replay
#: (`scripts/replay_structures.py`, Sept 25, 2026). The eleven that did not are on the builders'
#: branches (`s4a/founders`, `s4b/founders`) with their replays in `docs/runs/data/`.
FOUNDERS = {
...
class RegistryTests(unittest.TestCase):
    def test_the_founders_are_in_seeds_each_its_own_family(self):
