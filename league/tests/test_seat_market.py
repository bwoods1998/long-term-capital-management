...
class SeatCaps(unittest.TestCase):
    def test_desk_caps_and_the_population_follow_the_evidence(self):
        ...
        # Sept 25, 2026 (K1): sports 19 -> 24, a seat for each of the five sports-consensus founders; 25 with the UFC founder (K1c).
        for desk, cap in {"kalshi-weather": 17, "kalshi-sports": 25, "alpaca-index-etfs": 18, "alpaca-megacaps": 16,
