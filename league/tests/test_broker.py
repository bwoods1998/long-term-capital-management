...
class OrderExpiryTests(unittest.TestCase):
    ...
    OPTION = Instrument("option", "SPY", "alpaca", multiplier="100", expiry="2026-09-18", strike="450", right="call")

    def entry(self, **kwargs):
        options = dict(desk_id="d", instrument=self.OPTION, side="buy", quantity="1", order_type="limit",
                       limit_price="1.20", time_in_force="gtc", rationale="r", created_at=self.NOW, session_id="s")
