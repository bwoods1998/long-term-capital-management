...
DeskManifest = Any  # structural policy object; no runtime manifest parser
...
class RiskContext:
    ...
    market_open: bool | None = None  # None when unknown
...
def rule_quantity(intent: OrderIntent, ctx: RiskContext) -> str | None:
    ...
    if fractional and intent.instrument.asset_class in ("equity", "option"):
