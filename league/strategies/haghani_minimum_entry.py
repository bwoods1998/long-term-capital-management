# Corrected child of Haghani's crypto-alts-reversion strategy.
# Same specialty, signals and exits; skip final entry allocations below Alpaca's $10 minimum.
# This child starts with no inherited trading evidence.
