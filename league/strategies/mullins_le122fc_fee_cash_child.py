...
def decide(ctx):
    ...
    cancels = []
    # No series-specific maker schedule is supplied. Budget the higher taker fee.
    ...
    intents = []
    # Do not spend cash from requested but unconfirmed cancellations.
    ...
    for score, ticker, price in sorted(choices, reverse=True):
        ...
        # Account for upward rounding of the aggregate fee as well.
