...
# Same alternative-coin maker-reversion specialty and parameters.
# Preserve calculated limit prices rather than rounding them to cents.
# Dollar-budget rounding is unchanged. Venue price validation still applies.
