# options-gap-drift: ride a stock's news move for up to 4 days with a 3-10 day vertical in the move's direction.
#
...
# and SNAP went the other way and are left out; pooled, +0.95% the next day and +2.74% over three (21, 76%). EDGAR's 8-K Item 2.02 feed would name the earnings days, but the
