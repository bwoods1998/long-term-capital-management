...
def epoch_seconds(value: Any) -> int:
    """An ISO-8601 stamp as whole Unix seconds."""
...
def rfc3339(value: Any) -> str:
    """An ISO-8601 stamp as `YYYY-MM-DDTHH:MM:SSZ`."""
    moment = instant(value)
    if moment is None:
        raise ValueError(f"not an ISO-8601 timestamp: {value!r}")
...
class Instrument:
    ...
    expiry: str | None = None  # YYYY-MM-DD for options
    strike: Decimal | None = None
    right: str | None = None  # "call" | "put"
    market_id: str | None = None  # optional synthetic structure identity
    currency: str = "USD"
...
class Quote:
    ...
    source: str  # e.g. "alpaca:opra", "alpaca:sip", "sim"
    delayed: bool = True
