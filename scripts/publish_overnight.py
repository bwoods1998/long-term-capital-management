...
PROJECT_PATHS = ['public/overnight-research.json', 'public/overnight-sail-metrics.json', 'public/portfolio.json', 'public/investigations.json', 'public/project-status.json']
SITE_PATHS = ['portfolio/overnight-research.json', 'portfolio/snapshot.json', 'portfolio/investigations.json', 'portfolio/project-status.json']
