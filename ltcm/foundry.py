...
class Foundry:
    ...
    def origination_instructions(self, name: str, family: str) -> str:
        ...
        want = (f"Write ONE NEW strategy for the {family} family, not a mutation of anything: a repeatable edge you can price "
                ...
                "and write the code that tests it. Trade only markets that settle within twelve hours (the hourly crypto brackets, "
                "games in play, the day's brackets before their close): the floor refuses any event buy that settles later, a "
                "strategy earns its real-money record from settled positions, and the floor moves a candidate to real money after "
                "six of them, so hours beat days.")
