...
class BootstrapTests(StrategyCase):
    def test_desks_of_a_family_with_a_starter_get_it_once(self):
        ...
        self.assertEqual(
            deployed,
            ["haghani-2/daily_temps", "hilibrand-2/hourly_reversion", "hilibrand-2/spot_quotes", "mullins/kalshi_favorites", "mullins/daily_temps", "mullins/temps_ensemble", "mullins/poly_cross", "scholes-2/hourly_ranges", "scholes-2/hourly_quotes"],
        )
        ...
        self.assertEqual([s["name"] for s in self.strategies.report(events)["strategies"]], ["daily_temps", "kalshi_favorites", "poly_cross", "temps_ensemble"])
