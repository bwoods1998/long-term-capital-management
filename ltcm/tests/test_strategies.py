...
class BootstrapTests(StrategyCase):
    ...
    def test_an_event_contract_settling_past_the_horizon_is_refused_before_the_risk_engine(self):
        ...
        self.strategies.config["max_holding_hours"] = 12
        intents = [
        ...
        self.assertIn("settles more than 12h out", out[0]["reasons"][0])
    ...
    def test_desks_of_a_family_with_a_starter_get_it_once(self):
        ...
        self.assertEqual(
            deployed,
            ["haghani-2/daily_temps", "hilibrand-2/hourly_reversion", "hilibrand-2/spot_quotes", "mullins/kalshi_favorites", "mullins/temps_ensemble", "mullins/poly_cross", "scholes-2/hourly_ranges", "scholes-2/hourly_quotes"],
        )
        ...
        self.assertEqual([s["name"] for s in self.strategies.report(events)["strategies"]], ["kalshi_favorites", "poly_cross", "temps_ensemble"])
