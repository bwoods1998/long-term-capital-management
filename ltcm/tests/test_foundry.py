...
class CandidateTests(FoundryCase):
    ...
    def test_a_relative_family_qualifies_against_its_baseline_and_goes_live_on_its_forward_record(self):
...
class ServiceFoundryTests(ServiceCase):
    def test_the_service_builds_the_foundry_and_runs_it_off_the_tick_at_its_interval(self):
        ...
        self.assertEqual(foundry.config["interval_minutes"], 6, "the kalshi lane cycles every six minutes (Sept 19, 2026)")
        calls = []
