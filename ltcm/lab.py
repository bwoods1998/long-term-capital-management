...
KIT_API = (
    ...
    "kit.kalshi_market(ticker) -> one market (strike_type greater|less|between, floor_strike, cap_strike); kit.futures(root=None) -> Coinbase futures [{symbol, root, expiry, price, volume_usd}] nearest expiry first (check the contract your market settles on: basis matters); "
