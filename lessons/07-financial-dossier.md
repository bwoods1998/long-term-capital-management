...
The [rubric](../data/research/dossier-rubric.json) contains 64 numerical checks across
...
Start with the [nine-row audit](../data/research/working-capital-audit.json).
...
[Checked reconciliation](../docs/REVIEW-CASE.md)
