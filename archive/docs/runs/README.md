...
- [Learn what blocks the north star, then unblock it, September 23-24](2026-09-23-learn-and-unblock.md): the ten-hour run ([plan](../goals/LTCM_LEARN_AND_UNBLOCK.md)) that published [the agent study](../research/2026-09-23-agent-study.md) and unblocked its ranked blockers: the daily-loss rules as constitution keys, bunts that keep what they make, durable Kalshi shard funding, the lab off the OpenAI tier, the seat market and forward windows, with its deploys, ratifications and watch.
- [Capital is the ladder, September 23](2026-09-23-capital-ladder.md): the eight-hour north-star build ([plan](../goals/LTCM_NORTH_STAR_BUILD.md)): the allocator's bands of capital trading real money on both venues, the capital board, sliced exits, the Alpha Lab, a tick that never blocks, profit-indexed compute and the open desks, with its deploys, ratifications and watch.
- [Toward the north star, September 23](2026-09-23-north-star.md): the swing-and-bunt money rules, the near-miss revival, the DVOL and funding feeds and the transfer route, deployed at 03:52Z, and the watch that proposed the capital ladder.
