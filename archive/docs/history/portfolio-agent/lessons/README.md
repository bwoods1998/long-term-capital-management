> Historical development notes. For the active portfolio runtime, see the [project overview](../../../../README.md).
...
| When is a changed source ready to use? | [Reviewed source handoff](../pre-portfolio-2026-09-13/SOURCE-CURATION.md) |
...
brokerage integration is paused. The [roadmap](../ROADMAP.md) covers future
portfolio and infrastructure work. For the overall project, return to
[Start here](../START-HERE.md) or the [technical index](../../../README.md).
