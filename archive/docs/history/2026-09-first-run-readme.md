# The first run's README (September 15 to 19, 2026)

The repository's front page as it stood during the first run, moved here verbatim on September 20, 2026.
None of it runs today (see the [current README](../../README.md)); its paths are relative to the repository root.
